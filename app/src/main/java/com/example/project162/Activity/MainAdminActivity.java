...
public class MainAdminActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isLoggedIn) {
            startActivity(new Intent(MainAdminActivity.this, IntroActivity.class));
            finish();
        }
    ...
    private void setVariable() {
        ...
        binding.searchBtn.setOnClickListener(v -> {
            ...
            if (!text.isEmpty()) {
                Intent intent = new Intent(MainAdminActivity.this, ListFoodsActivity.class);
        ...
        binding.cartBtn.setOnClickListener(v -> startActivity(new Intent(MainAdminActivity.this, MaincartActivity2.class)));

        binding.filterBtn.setOnClickListener(v -> startActivity(new Intent(MainAdminActivity.this, ProfileActivity.class)));
    }
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (list.size()>0){
                        binding.bestFoodView.setLayoutManager(new LinearLayoutManager(MainAdminActivity.this,LinearLayoutManager.HORIZONTAL,false));
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!likedFoods.isEmpty()) {
                    LinearLayoutManager layoutManager = new LinearLayoutManager(MainAdminActivity.this, LinearLayoutManager.HORIZONTAL, false);
                    binding.likedFoodView.setLayoutManager(layoutManager);
                    LikedFoodsAdapter adapter = new LikedFoodsAdapter(likedFoods, MainAdminActivity.this);
